<div class="content-wrapper" ng-app="translatorApp" ng-controller="translatorCtrl">
  <section class="content-header">
    <h1>
      ویرایش
      <small>ترجمه‌های ۲۴ ساعت گذشته</small>
    </h1>
  </section>
  <section class="content">
    <div class="box box-warning">
      <div class="box-header with-border">
        <h3 class="box-title">لیست ترجمه‌های ۲۴ ساعت گذشته</h3>
      </div>
      <div class="box-body" ng-init="get_last24_translates()">
			...
			<tr ng-repeat="item in temp_sentences">
				<td>
					<form role="form">
					  ...
					  <div class="form-group">
						  <button class="btn btn-block btn-primary btn-flat" ng-click="submit_translate(item)">ثبت تغییرات</button>
					  </div>
					</form>
				</td>
			</tr>
...
<script type="text/javascript">
  ...
  .config(function(NotificationProvider) {
    ...
    $scope.get_last24_translates = function(){
      var postData  = $.param({
                  csrf_token : '<?php echo $this->security->get_csrf_hash(); ?>'
                });
      $http.post('<?php echo base_url(); ?>api/get_last24_translates', postData, {headers : {'Content-Type': 'application/x-www-form-urlencoded'}})
        .then(function successCallback(response) {
            ...
            Notification.error({message: 'متاسفانه خطایی در پردازش lllاطلاعات رخ داد!'});
        });
    }
